    ...
    methods: {
                ...
                try {
                    ...
                    if (resp.ok) {
                        ...
                        this.allCourses = raw.map(c => {
                            ...
                            // Use provided image; if none, prefer prefix.png; otherwise use default.png
                            const image = c.image || (prefix ? `${prefix}.png` : 'default.png');
        ...
        getCourseImage(courseOrId) {
            if (courseOrId && typeof courseOrId === 'object') {
                ...
                // If course has explicit image field
                if (course.image) {
                ...
                // Try to use course code prefix as image name
                const courseCode = course.id || course.course_code || course.courseCode || '';
                if (courseCode) {
        ...
        handleImageError(event) {
            try {
                ...
                // Only change to default.png if not already using it
